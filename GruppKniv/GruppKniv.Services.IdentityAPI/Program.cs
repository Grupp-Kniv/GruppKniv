...
}).AddInMemoryIdentityResources(StaticDetatiles.IdentityResources)
  .AddInMemoryApiScopes(StaticDetatiles.ApiScopes)
  .AddInMemoryClients(StaticDetatiles.Clients)
